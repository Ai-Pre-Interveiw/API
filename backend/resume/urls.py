...
from .views import upload_resume, get_resume, interview_questions, create_interview, create_interview_result, interview_results_by_interview_id, update_interview_result, get_all_interviews, get_specific_interview, update_interview, generate_questions
...
urlpatterns = [
    ...
    path('interview/create/question/<int:interview_id>/', generate_questions, name='create_question'),
